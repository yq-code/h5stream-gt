<template>
  <div class="h5videowrapper h5container">
    ...
    <div class="h5controls" style="display:none;padding:0px">
      <button type="button" class="btn vidbuttion pull-right" title="关闭窗口" @click="CloseVideo($event)"><i
        class="mdi mdi-close"></i>
      </button>
      <button type="button" class="btn vidbuttion pull-right" title="全屏显示" @click="FullScreen($event)"><i
        class="mdi mdi-fullscreen"></i></button>
      <button type="button" class="btn vidbuttion pull-right" title="控制面板" @click="PtzControlShow($event)"><i
        class="mdi mdi-parking"></i></button>
      <button type="button" class="btn vidbuttion pull-right" title="停止记录" @click="DoManualRecordStop($event)"><i
        class="mdi mdi-stop"></i></button>
      <button type="button" class="btn vidbuttion pull-right" title="开始记录" @click="DoManualRecordStart($event)"><i
        class="mdi mdi-record"></i></button>
      <button type="button" class="btn vidbuttion pull-right" title="视频截图" @click="DoSnapshot($event)"><i
        class="mdi mdi-camera"></i>
      </button>
      <button type="button" class="btn vidbuttion pull-right" title="麦克风开关" @click="Shoutwheat($event)"><i
        :class="Shoutwheatclass"></i></button>
      <!--<button type="button" class="btn vidbuttion pull-right" title="截图下载" @click="DoSnapshotWeb($event)"><i-->
    ...
    <div class="ptzcontrols" style="display:none padding:0px">
      <div class="row ">
        ...
        <button type="button" class="btn ptzbuttonnone pull-right" href="#"><i></i></button>
        <button type="button" class="btn ptzbutton pull-right" href="#"
                @mousedown="PtzActionUp($event)" @mouseup="PtzActionStop($event)" @touchstart="PtzActionUp($event)"
                @touchend="PtzActionStop($event)"><i class="mdi  mdi-arrow-up"></i></button>
      </div>
      <div class="row ">
        <button type="button" class="btn ptzbuttonnone pull-right" href="#"><i></i></button>
        <button type="button" class="btn ptzbuttonnone pull-right" href="#"><i></i></button>
        ...
        <button type="button" class="btn ptzbuttonnone pull-right" href="#"><i></i></button>
        <button type="button" class="btn ptzbutton pull-right" href="#"
                @mousedown="PtzActionLeft($event)" @mouseup="PtzActionStop($event)" @touchstart="PtzActionLeft($event)"
                @touchend="PtzActionStop($event)"><i class="mdi  mdi-arrow-left"></i></button>
      </div>
      <div class="row ">
        <button type="button" class="btn ptzbuttonnone pull-right" href="#"><i></i></button>
        <button type="button" class="btn ptzbutton pull-right" href="#"
        ...
        <button type="button" class="btn ptzbuttonnone pull-right" href="#"><i></i></button>
        <button type="button" class="btn ptzbutton pull-right" href="#"
                @mousedown="PtzActionDown($event)" @mouseup="PtzActionStop($event)" @touchstart="PtzActionDown($event)"
                @touchend="PtzActionStop($event)"><i class="mdi  mdi-arrow-down"></i></button>
      </div>
    </div>
  </div>
</template>
